...
# python3 src/utils/preprocess.py -c configs/configclass.yaml -m train
export OMP_NUM_THREADS=1
torchrun --nproc_per_node=8 --nnodes=1 --node_rank=0 src/main_rpm.py -c configs/configclass.yaml
