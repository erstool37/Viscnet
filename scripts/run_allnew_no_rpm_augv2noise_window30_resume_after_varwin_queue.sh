...
RUN_NAME="allnew_synthetic_pretrain_sph35000_no_rpm_augv2noise_window30_randtemporal_diag_resume_after_varwin_ep62"
CONFIG="configs/rebuild/retries/${RUN_NAME}.yaml"
LOG_DIR="outputs/rebuild_reproduction/logs"
SUMMARY_DIR="outputs/rebuild_reproduction/allnew_no_rpm_augv2noise_window30_resume_after_varwin_queue"
MARKER_DIR="outputs/rebuild_reproduction/session_markers"
SUMMARY_PATH="${SUMMARY_DIR}/summary.json"
MARKER_PATH="${MARKER_DIR}/allnew_no_rpm_augv2noise_window30_resume_after_varwin_queue.done"
LOG_PATH="${LOG_DIR}/${RUN_NAME}.log"
SOURCE_CHECKPOINT="outputs/rebuild_reproduction/checkpoints/allnew_synthetic_pretrain_sph35000_no_rpm_augv2noise_window30_randtemporal_diag_ep70.pth"
OUTPUT_CHECKPOINT="outputs/rebuild_reproduction/checkpoints/${RUN_NAME}.pth"
PORT="${ALLNEW_WINDOW30_RESUME_PORT:-30492}"
...
payload = {
    ...
    "run_name": "allnew_synthetic_pretrain_sph35000_no_rpm_augv2noise_window30_randtemporal_diag_resume_after_varwin_ep62",
    "config": "configs/rebuild/retries/allnew_synthetic_pretrain_sph35000_no_rpm_augv2noise_window30_randtemporal_diag_resume_after_varwin_ep62.yaml",
    "source_checkpoint": "outputs/rebuild_reproduction/checkpoints/allnew_synthetic_pretrain_sph35000_no_rpm_augv2noise_window30_randtemporal_diag_ep70.pth",
    "output_checkpoint": "outputs/rebuild_reproduction/checkpoints/allnew_synthetic_pretrain_sph35000_no_rpm_augv2noise_window30_randtemporal_diag_resume_after_varwin_ep62.pth",
    "log": "outputs/rebuild_reproduction/logs/allnew_synthetic_pretrain_sph35000_no_rpm_augv2noise_window30_randtemporal_diag_resume_after_varwin_ep62.log",
